...
const ExchangeRateCalculator = () => {
  ...
  return (
    <section className="w-full py-12 md:py-20 px-4 md:px-8 bg-[#f5f1ed]">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
          {/* Left Column - Marketing Content */}
          <div className="flex-1 w-full lg:w-1/2">
            <div className="max-w-lg">
              <p className="text-sm text-gray-800 mb-3 tracking-wide">
                International money transfer
              </p>
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-black mb-5 leading-[0.95] tracking-tight text-gray-900">
                At Great Value.
              </h2>
              <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-8">
                Easily send money directly to loved ones across the globe
              </p>

              {/* Phone download section */}
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 bg-white rounded-full px-4 py-3 shadow-sm border border-gray-200">
                    <CircleFlag countryCode="gb" height="24" width="24" />
                    <ChevronDown className="w-3.5 h-3.5 text-gray-400" />
                  </div>
                  <div className="flex-1 bg-white rounded-full px-5 py-3 shadow-sm border border-gray-200">
                    <span className="text-gray-500 text-sm">+44</span>
                  </div>
                </div>
                <button className="w-full sm:w-auto px-8 py-3.5 bg-[#6db566] hover:bg-[#5ea357] text-white font-semibold text-sm rounded-full transition-colors shadow-sm">
                  Download now
                </button>
              </div>
            </div>
          ...
          <div className="flex-1 w-full lg:w-1/2 flex justify-center lg:justify-end">
            <div className="w-full max-w-lg">
              <div className="bg-white rounded-[2rem] shadow-[0_0_30px_rgba(0,0,0,0.18)] p-8 md:p-10 overflow-visible">
                ...
                {/* Exchange rate */}
                <div
                  className="flex items-center justify-between mb-8 w-full px-4 py-3 rounded-full"
                  style={{ backgroundColor: "#16330014" }}
                >
                ...
                {/* Send Money Button */}
                <button
                  className="w-full py-2 bg-[#9FE870] hover:bg-[#8dd661] font-semibold text-[18px] rounded-full transition-all"
                  style={{ color: "#163300" }}
                >
                  Send money
                </button>
